...
while chioce_level_num <= 8:  # цикл проигрывания уровня
    ...
    while running:
        ...
        if coin_pickup:
            count_coin_cur_level -= 1 # увеличиваем количество подобранных монет
            score += 1 # увеличиваем общий счет
            pygame.mixer.music.load('data/music/coin.mp3')  # подгружаем файл с музыкой
            pygame.mixer.music.play()  # включаем музыку
        if count_coin_cur_level == 0:  # уровень завершен
            level_end = True
